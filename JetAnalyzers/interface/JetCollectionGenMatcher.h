#ifndef JetMETAnalysis_JetAnalyzers_JetCollectionGenMatcher_h
#define JetMETAnalysis_JetAnalyzers_JetCollectionGenMatcher_h
...
#include "JetMETAnalysis/JetAnalyzers/interface/GenJet.h"
                 ...
                 double minPtRel = -1.) const
  {
    for(const RecoJet & recJet: recJets)
    {
      ...
      if(bestMatch)
      {
        ...
        recJet_nonconst->set_genJet(&genJet);
      }
    }
  }
};

#endif // JetMETAnalysis_JetAnalyzers_JetCollectionGenMatcher_h
