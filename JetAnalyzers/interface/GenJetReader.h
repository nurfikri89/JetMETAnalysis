#ifndef JetMETAnalysis_JetAnalyzers_GenJetReader_h
#define JetMETAnalysis_JetAnalyzers_GenJetReader_h

#include "JetMETAnalysis/JetAnalyzers/interface/ReaderBase.h" // ReaderBase
...
#endif // JetMETAnalysis_JetAnalyzers_GenJetReader_h
