#ifndef JetMETAnalysis_JetAnalyzers_TTreeWrapper_h
#define JetMETAnalysis_JetAnalyzers_TTreeWrapper_h

/** \class TTreeWrapper
 *
 * Auxiliary class to read events from nanoAOD Ntuple.
 * The class automatically calls TTree::SetBranchAddress whenever a new ROOT files gets opened.
 *
...
#endif // JetMETAnalysis_JetAnalyzers_TTreeWrapper_h
